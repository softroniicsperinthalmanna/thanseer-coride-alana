...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2023 at 12:16 PM
...
(1, 18, 'pmna', 'Calicut ', 'kl53e3245', '6:43 PM', '2023-07-13');
...
CREATE TABLE `register` (
  ...
  `username` varchar(20) NOT NULL DEFAULT 'Add username'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `register` (`register_id`, `log_id`, `dp`, `first_name`, `last_name`, `email`, `username`) VALUES
(1, 1, '', 'muhammed', 'Thanseer', 'thanzeetnz83@gmail.com', 'thansi__i'),
(2, 2, '', 'peter', 'griffin', NULL, '');
...
--
ALTER TABLE `group_trip`
  MODIFY `gt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `offer_pool`
  MODIFY `pool_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
